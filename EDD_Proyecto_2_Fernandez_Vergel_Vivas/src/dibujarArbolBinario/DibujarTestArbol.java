...
public class DibujarTestArbol extends JPanel {
    
    private arbolBinario.ArbolBinario miArbol;
    ...
    /**
     * Constructor de la clase DibujarArbolTest.El constructor permite
 inicializar los atributos de la clase DibujarArbolTest y llama al
 método repaint(), que es el encargado de pintar el Arbol.
     ...
     * dibujar.
     */
    public DibujarTestArbol(arbolBinario.ArbolBinario miArbol) {
    ...
    private void calcularPosiciones() {
        posicionNodos.clear();
        subtreeSizes.clear();
        NodoArbol root = this.getMiArbol().getRoot();
        if (root != null) {
    ...
    public void paint(Graphics g) {
        ...
        dibujarArbol(g2d, this.getMiArbol().getRoot(), Integer.MAX_VALUE, Integer.MAX_VALUE,
                fm.getLeading() + fm.getAscent());
        fm = null;
    }

    public arbolBinario.ArbolBinario getMiArbol() {
        return miArbol;
    }

    public void setMiArbol(arbolBinario.ArbolBinario miArbol) {
        this.miArbol = miArbol;
    }
}
