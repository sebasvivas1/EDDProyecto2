...
public class TestJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Dibujar Arbol");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestJuego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
